...
<div class="wrapper">
            ...
            <?= dmstr\widgets\Menu::widget(
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Data Pegawai', 'icon' => 'user', 'url' =>['/pegawai']],
                        ['label' => 'Data Mustahik', 'icon' => 'user', 'url' => ['/mustahik']],
                        ['label' => 'Data Jenis Zakat', 'icon' => 'fas fa-edit', 'url' => ['/jenis-zakat']],
                        ['label' => 'Data Jenis Program','icon' => 'fas fa-edit', 'url' => ['/jenis-program']],
                        ['label' => 'Info Program','icon' => 'far fa-clipboard', 'url' => ['/info-program']],
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="#">Lembaaga Amil Zakat Swadaya Ummah</a>.</strong> All rights reserved.
    </footer>
